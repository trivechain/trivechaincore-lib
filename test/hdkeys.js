...
var HDPrivateKey = trivechaincore.HDPrivateKey;
var HDPublicKey = trivechaincore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = trivechaincore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(trivechaincore.crypto.BN.prototype, 'toBuffer').callsFake(function(args) {
      ...
      sandbox.spy(trivechaincore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      trivechaincore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = trivechaincore.PublicKey.fromPoint;
      trivechaincore.PublicKey.fromPoint = function() {
        trivechaincore.PublicKey.fromPoint = unstubbed;
