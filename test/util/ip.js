...
describe('ip', function () {
  ...
  describe('#ipAndPortToBuffer', function () {
    ...
    it('Should accept only zero ipv6, if ipv6 is passed as an arg, as implemented in trivechaincore', function () {
  ...
  describe('#bufferToIpAndPort', function () {
    ...
    it('Should return zero ipv6 if hex is zero, as it works in trivechaincore', function () {
