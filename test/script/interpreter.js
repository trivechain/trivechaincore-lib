...
var script_valid = require('../data/trivechaind/script_valid');
var script_invalid = require('../data/trivechaind/script_invalid');
var tx_valid = require('../data/trivechaind/tx_valid');
var tx_invalid = require('../data/trivechaind/tx_invalid');

//the script string format used in trivechaind data tests
Script.fromTrivechaindString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.fromTrivechaindString(vector[0]);
    var scriptPubkey = Script.fromTrivechaindString(vector[1]);
  ...
  describe('trivechaind script evaluation fixtures', function() {
  ...
  describe('trivechaind transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //trivechaind casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromTrivechaindString(scriptPubKeyStr);
          });
