...
var x16rhash = require('@trivechain/x16r-hash-js'); // TRVC 2.0
var x16rv2hash = require('@trivechain/x16rv2-hash-js'); // TRVC 2.1
...
Hash.x16r = function(buf) {
  $.checkArgument(BufferUtil.isBuffer(buf));
  return x16rhash.x16r(buf);
};

// TRVC 2.1
Hash.x16rv2 = function(buf) {
  $.checkArgument(BufferUtil.isBuffer(buf));
  return x16rv2hash.x16rv2(buf);
};
