declare module "@trivechain/trivechaincore-lib" {
    /**
    ...
    export class Address {
         ...
         *
         * @param {string} str - A string of the Trivechain address
         * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
         * @param {string=} type - The type of address: 'script' or 'pubkey'
         * @returns {Address} A new valid and frozen instance of an Address
         */
         ...
         *
         * @returns {Buffer} Trivechain address buffer
         */
        toBuffer(): Buffer;
         ...
         *
         * @returns {string} Trivechain address
         */
        toString(): string;
...
// @ts-ignore
    ...
    export class Signature {
        ...
        /**
         * This function is translated from trivechaind's IsDERSignature and is used in
        ...
        /**
         * Compares to trivechaind's IsLowDERSignature
         ...
         * Translated from trivechaind's IsDefinedHashtypeSignature
         */
    ...
    /**
     * @class trivechaincore
     */
    export class trivechaincore {
    }

    export namespace trivechaincore {
        /**
         * @constructor
         */
        class Error {
    ...
    export class GovObject {
        ...
        /**
         * Retrieve a hex string that can be used with trivechaind's CLI interface
         *
    ...
    export class HDPublicKey {
         ...
         * @param {string|Network=} network - optional, if present, checks that the
         *     network provided matches the network serialized.
         * @return {trivechaincore.Error|null}
         */
        static getSerializedError(data: string | Buffer, network: string | Network): trivechaincore.Error | null;
    ...
    export class Message {
        ...
        /**
         * Will sign a message with a given Trivechain private key.
         *
    ...
    /**
     * Trivechain transactions contain scripts. Each input has a script called the
    ...
    /**
     * A Trivechain transaction script. Each transaction's inputs and outputs
    ...
    export class Script {
        ...
        /**
         * Analogous to trivechaind's FindAndDelete. Find and delete equivalent chunks,
        ...
        /**
         * Comes from trivechaind's script interpreter CheckMinimalPush function
         * @returns {boolean} if the chunk {i} is the smallest way to push that particular data.
         */
        checkMinimalPush(): boolean;

        /**
         * Comes from trivechaind's script DecodeOP_N function
         * @param {number} opcode
        ...
        /**
         * Comes from trivechaind's script GetSigOpCount(boolean) function
    ...
    export class Transaction {
         ...
         *
         * @param {Object} opts allows to skip certain tests. {@see Transaction#serialize}
         * @return {trivechaincore.Error}
         */
        getSerializationError(opts: any): trivechaincore.Error;

        /**
         * Instant send fee is based on the number of inputs, not on the transaction size
         * @return {number}
         */
        estimateDirectSendFee(): number;
         ...
         *
         * Can receive, as output information, the output of trivechaind's `listunspent` command,
         * and a slightly fancier format recognized by trivechaincore:
         *
         * ```
         * {
         ...
         * }
         * ```
         * Where `address` can be either a string or a trivechaincore Address object. The
         * same is true for `script`, which can be a string or a trivechaincore Script.
         *
         ...
         *
         * // From a pay to public key hash output from trivechaind's listunspent
        ...
        /**
         * Analogous to trivechaind's IsCoinBase function in transaction.h
         */
        isCoinbase(): void;
     ...
     * Bitcore URI
     *
     * Instantiate an URI from a Trivechain URI String or an Object. A URI instance
     * can be created with a Trivechain URI string or an object. All instances of
     ...
     * ```
     *
     * @param {string|Object} data - A Trivechain URI string or an Object
    ...
    export class URI {
         ...
         *
         * @returns {string} Trivechain URI string
         */
        toString(): string;
