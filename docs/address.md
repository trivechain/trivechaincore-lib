# Trivechain Address
Represents a Trivechain address. Addresses are the most popular way to make Trivechain transactions. See [the Trivechain documentation](https://dash-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/trivechain/trivechaincore-lib/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/trivechain/trivechaincore-lib/tree/master/lib/errors/spec.js).
