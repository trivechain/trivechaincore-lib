...
For detailed technical information about a block please visit [Blocks](https://dash-docs.github.io/en/glossary/block) on the Trivechain Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://dash-docs.github.io/en/developer-reference#block-headers) page on the Trivechain Developer Reference Wiki.
