...
A Governance Object (or "govObject") is a generic structure introduced in Trivechain Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
####  `checkedSerialize`
Return a hex string that can be used in trivechaind CLI
####  `serialize`
Return a hex string
####  `inspect`
...
var jsonProposal = {
  ...
  payment_amount: 10,
  type: 1,
  url: "http://www.trivechain.com/proposal/first_proposal"
};
...
```javascript
proposal.url = "http://trivechain.com/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url = "http://trivechain.com/fixedUrl"
